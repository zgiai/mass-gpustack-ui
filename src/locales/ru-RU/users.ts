export default {
  ...
  'users.button.create': 'Новый пользователь',
  'users.form.edit': 'Редактировать пользователя',
  ...
  'users.version.islatest': 'ZGP {version} — последняя версия',
  'users.version.update': 'Доступно обновление ZGP {version}',
